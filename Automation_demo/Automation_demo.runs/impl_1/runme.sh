...
HD_PWD='/home/vlsidesign16/Work/IC_Design/Auto/Automation_demo/Automation_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_CLA32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_CLA32.tcl -notrace
